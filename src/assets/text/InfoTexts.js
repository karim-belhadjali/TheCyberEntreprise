    ...
    documents: [
      {
        ...
        release_date: "Release Date: May 2nd, 2022",
        read_time: "Read Time: 4 minutes",
        content:
          "The new Cyber Enterprise website is on the horizon, and with that comes the start of the highly anticipated operation ‘Perfect Storm’ initiative. As a sneak peek preview, the web development team put together a video led by team member Karim demonstrating the calculator page from the website. This is just one of the many pages scheduled to be present upon launch day It demonstrates the complexity the Cyber Enterprise strives to achieve and that there’s always more than meets the eye. ",
      },
      {
        title: "Beginning of Phase III",
        release_date: "Release Date: March 2nd, 2022",
        read_time: "Read Time: 8 minutes  ",
        content:
          "With the dawn of a new era approaching, this article goes in-depth with the ambitions the Cyber Enterprise intends to undergo as the new custom contract went live and was introduced. Collecting marketing data and how the Cyber Enterprise intends to do this is mentioned, as well as a giveaway event that would support building a bigger and stronger community.",
      },
      {
      ...
      },
      {
        ...
        release_date: "Release Date: October 25th, 2021",
      ...
      },
      {
        ...
        release_date: "Release Date: October 18th, 2021",
        read_time: "Read Time: 6 Minutes",
        content:
      ...
      },
      {
        ...
        release_date: "Release Date: October 11th, 2021",
        read_time: "Read Time: 6 Minutes",
        content:
      ...
      },
      {
        ...
        release_date: "Release Date: October 4th, 2021",
        read_time: "Read Time: 7 Minutes",
        content:
          "This article provides a summary of the first community call that was held on Saturday, October 2nd, 2021. In this call, an outline of a New Cyber website was presented to the community where feedback was taken into account, discussed, and noted. Coming on board and partnering with us on this endeavour was community member Tease who announced that he will help us create a new website with his years of expertise. The initial web features and brainstormed pages are discussed within this article.",
      },
      {
        title: "The Journey of Phase I",
        release_date: "Release Date: September 25th, 2021",
      ...
      {
        title: "Origins",
        release_date: "Release Date: September 13, 2021",
      ...
      sections: [
        {
          ...
          content:
            "The concept behind the Cyber Enterprise was to create a token without expiration, remaining indefinitely on the blockchain no matter what global events take place. A token not on the blockchain is something merely imitating a token and thus not a cryptocurrency. The blockchain is what provides credibility to investors, amongst other things. We strive to create a series of decentralized applications with the Cyber (CYBR) token having a place in everything we create. We knew we wanted the token to have multiple use cases, and therefore a token with a low supply was not our intent. We wanted a token with a limited supply, but for this initial amount to be enough to span multiple ecosystems and thus use cases. There will never be more of the Cyber (CYBR) token on the market.",
        },
        {
          title: "What is a token?",
          content:
            "A token can be viewed as a digital asset that represents value, but aren’t inherent value themselves. In the case of the Cyber (CYBR) Token, it has the ability to be exchanged for Ethereum (ETH). Alternatively, our token strives to be the primary currency within our ever-growing and developing Cyber Enterprise ecosystem in which it can be used as a form of payment.",
        },
        {
          title: "Can the token be mined/minted/created?",
          content:
            "In our case, the Cyber (CYBR) token can not be considered a minable/mintable asset, as it was specifically created and launched with a max supply released all at once on the market. The token can now be purchased on UniSwap V3, ShibaSwap, won through giveaways, or earned through future internal reward systems, such as locking and liquidity providing. A CYBR (CYBR) token to USD pair is not available at this time, but a CYBR/ETH pair is. Ethereum can be bought with USD or other fiat currencies such as EUR through a centralized exchange.",
        },
        {
      ...
      sections: [
        {
          ...
          content:
            "Our smart contracts are written in Solidity, which is native to the Ethereum blockchain. They are defined algorithms that establish parameters for transactions. If the parameters of the contract are not fulfilled the contract will not be executed.",
        },
        {
          title: "What is a Contract Address on Ethereum?",
          content:
            "The contact address is the outcome of a hash algorithm that represents the smart contract with a unique code, where it can be publicly viewed on the Ethereum blockchain.",
        },
        {
          title: "How does our smart contract work?",
          content:
            "Unlike a NFT smart contract, we do not govern the rules of minting an nft, but rather trading our native token. Our smart contract has measures for inflation, bot mitigation and maintenance along with many more functions.",
        },
      ],
    },
    {
      ...
      sections: [
        {
          ...
          content:
            "The max supply in crypto is the maximum amount of tokens that will ever exist in that cryptocurrency lifetime. In the specific case of the Cyber (CYBR), the max supply is equivalent to the initial supply which is 1 Quadrillion (1,000,000,000,000,000) tokens, and as there is no minting there will never be more.",
        },
        {
          title: "How to calculate max supply?",
          content:
            "The max supply of a digital currency such as in the case of the Cyber (CYBR) token can be viewed on Etherscan, thus no calculation is needed. Our currency is not minable/mintable, therefore this number will never change. Within Etherscan you can also locate when the initial supply was made, the transaction hash, and the creator wallet that minted the tokens.",
        },
      ],
    },
    {
      ...
      sections: [
        {
          ...
          content:
            "The reason why a circulating supply is important is due to the fact that it refers to the number of tokens that are publicly available. The circulating supply refers to the tokens on market, as well as those in the Possession of the holders.",
        },

        {
          title: "How does circulating supply affect a cryptocurrency?",
          content:
            "Circulating supply and price have an indirect correlation with one another. Typically, the circulating supply of a cryptocurrency may increase or decrease over a given time. However, the Cyber (CYBR) tokens available circulating supply will gradually decrease due to implemented burn mechanisms. These were set out to gradually reduce the number of tokens available on the market, making it a deflationary asset, as it is impossible to sell tokens from our burn wallet.",
        },
        {
    ...
    },
    {
      ...
      sections: [
        ...
        },
        {
          ...
          content:
            "A liquidity provider in crypto is considered a market maker who is responsible for enhancing the liquidity on a trading platform such as a decentralized exchange (DEX). As the Cyber (CYBR) token works on the Ethereum blockchain, this is done by making a pair with both Ethereum, and the native token. Doing so enables the liquidity provider to gain profits from individuals buying and selling the digital asset. ",
        },
      ],
    },
    {
